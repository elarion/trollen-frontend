                ...
                <SafeAreaView style={styles.container} edges={['left', 'top']}>
                    ...
                    <View style={styles.selectCategories}>
                        <TouchableOpacity onPress={() => setViewMode('races')} >
                            <Text style={[styles.subSubTitle, { color: viewMode === 'races' ? '#C39D88' : '#55453F', borderBottomWidth: viewMode === 'spells' ? 0 : 2, fontWeight: viewMode === 'spells' ? '0' : '800' }]}>Races</Text>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => setViewMode('spells')}>
                            <Text style={[styles.subSubTitle, { color: viewMode === 'spells' ? '#C39D88' : '#55453F', borderBottomWidth: viewMode === 'spells' ? 2 : 0, fontWeight: viewMode === 'spells' ? '800' : '0' }]}>Spells</Text>
                        </TouchableOpacity>
                    </View>
